...
## 基于 APT-based 系统(Debian, Ubuntu, Mint, etc.)

### 1. 安装[shadowsocks-libev](https://github.com/shadowsocks/shadowsocks-libev)

- 从 PPA 安装[ppa:max-c-lv/shadowsocks-libev](https://launchpad.net/~max-c-lv/+archive/ubuntu/shadowsocks-libev)
...
### 8. 安装 virtualenv 及[autoenv](https://github.com/kennethreitz/autoenv)
